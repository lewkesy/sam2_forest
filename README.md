...
**Please find the forest segmentation script in sam2/segment_forest.py. Please follow the original SAM2 project for environment setup, then follow the script for segmentation.** 
